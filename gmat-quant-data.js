      ...
      blocks: [
        ...
        { type: "practice", questions: [
          ...
          },
          {
            ...
            correct: "C",
            steps: [
              "Statement (1) alone: gives prices but not quantities of each, so two unknowns and one equation. <strong>Not sufficient.</strong>",
        ...
        { type: "practice", questions: [
          ...
          },
          {
            ...
            steps: [
              ...
              "Statement (2) alone: gives the explicit set, so standard deviation is directly computable. <strong>Sufficient.</strong>",
              "Answer: B."
            ]
          }
        ]}
        ...
        { type: "practice", questions: [
          {
            ...
            correct: "D",
            steps: [
              "Statement (1): $n/2$ being an integer means $n$ divides evenly by 2, which is the definition of even. <strong>Sufficient.</strong>",
